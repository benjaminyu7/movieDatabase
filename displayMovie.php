...
<div class="container-flex">
	...
	<div class="col-auto">
	    <div class="card">
		<img src=<?php echo "\"",$moviePicture,"\"" ?> alt="Movie Picture" class="card-img-top movie-img ml-auto mr-auto">
		<div class="card-footer card-footer pt-0 pb-0">
		    <!-- Movie Title -->
	...
	<div class="col">
		...
		<?php 
			if ($hasDirector) {
				echo '<div class="col-auto"><p><strong>Director:</strong> '.$directorName.'<p></div>';
			}
		?>
		<!-- producer -->
		<?php 
			if ($hasProducer) {
				echo '<div class="col-auto"><p><strong>Producer:</strong> '.$producerName.'<p></div>';
			}
		?>
	    </div>
